...
#         self.dataset_containing_games_to_eval_statistics: Dict[int, Transition] = {}
#
...
#                     continue
#                 else:
#                     self.dataset_containing_games_to_eval_statistics[dict_position] = game
#                     dict_position += 1
#                     self.n_games -= 1
#
#         assert len(self.dataset_containing_games_to_eval_statistics) != 0, "No data for evaluation, probably set too " \
...
#
#     def diff_value_input_state_vs_subgoals_multi_games(
#             self,
...
#             self.chess_stats_eval_dataset_creator.dataset_containing_games_to_eval_statistics
#
