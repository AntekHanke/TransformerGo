...
class TrainModel(Job):
    def __init__(
        ...
        assert checkpoint_path is not None, "checkpoint_path is not set"

        log_param("checkpoint_path", checkpoint_path)
        ...
        self.training_args = training_args_cls(resume_from_checkpoint=checkpoint_path, output_dir=self.out_dir + "/out")
