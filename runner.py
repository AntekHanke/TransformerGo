...
def _parse_args():
    ...
    parser.add_argument("--config_file", action="append", default=[], help="Gin configs files.")
    parser.add_argument("--config", action="append", default=[], help="Gin configs overrides.")
    parser.add_argument(
        "--mrunner",
        action="store_true",
        ...
        if "use_neptune" in specification["parameters"]:
            if specification["parameters"]["use_neptune"]:
                ...
                try:
                    ...
                    print("HINT: To run with Neptune logging please set your " "NEPTUNE_API_TOKEN environment variable")
