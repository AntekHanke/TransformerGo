...
def check_config_section(
    ...
    data_location = (
        f"`{data_name}` subsection in `{subsection}`"
        if subsection
        else f"Section `{data_name}`"
    )
    type_error_message = {
    ...
    config_assert(
        isinstance(config_part[data_name], data_type), type_error_message[data_type]
    )
...
def insert_default_values(CONFIG: CONFIG_DICT_TYPE) -> None:
    ...
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="offer_draw_enabled", default=False
    )
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="offer_draw_for_egtb_zero", default=True
    )
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="resign_enabled", default=False
    )
    set_config_default(
        CONFIG,
        "engine",
    ...
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="resign_moves", default=3
    )
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="resign_score", default=-1000
    )
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="offer_draw_moves", default=5
    )
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="offer_draw_score", default=0
    )
    set_config_default(
        CONFIG, "engine", "draw_or_resign", key="offer_draw_pieces", default=10
    )
    set_config_default(
        CONFIG, "engine", "online_moves", key="max_out_of_book_moves", default=10
    )
    set_config_default(
        CONFIG,
        "engine",
    ...
    set_config_default(
        CONFIG, "engine", "online_moves", "online_egtb", key="min_time", default=20
    )
    set_config_default(
        CONFIG, "engine", "online_moves", "online_egtb", key="max_pieces", default=7
    )
    set_config_default(
        CONFIG,
        "engine",
    ...
    set_config_default(
        CONFIG, "engine", "online_moves", "chessdb_book", key="min_time", default=20
    )
    set_config_default(
        CONFIG,
        "engine",
    ...
    set_config_default(
        CONFIG, "engine", "online_moves", "chessdb_book", key="contribute", default=True
    )
    set_config_default(
        CONFIG,
        "engine",
    ...
    set_config_default(
        CONFIG, "engine", "lichess_bot_tbs", "syzygy", key="enabled", default=False
    )
    set_config_default(
        CONFIG, "engine", "lichess_bot_tbs", "syzygy", key="max_pieces", default=7
    )
    set_config_default(
        CONFIG,
        "engine",
    ...
    set_config_default(
        CONFIG, "engine", "lichess_bot_tbs", "gaviota", key="enabled", default=False
    )
    set_config_default(
        CONFIG, "engine", "lichess_bot_tbs", "gaviota", key="max_pieces", default=5
    )
    set_config_default(
        CONFIG,
        "engine",
    ...
    set_config_default(
        CONFIG, "engine", "polyglot", key="selection", default="weighted_random"
    )
    ...
    set_config_default(
        CONFIG, "challenge", key="block_list", default=[], force_empty_values=True
    )
    ...
    CONFIG["matchmaking"]["challenge_timeout"] = max(
        CONFIG["matchmaking"]["challenge_timeout"], 1
    )
    set_config_default(
        CONFIG, "matchmaking", key="block_list", default=[], force_empty_values=True
    )
    set_config_default(
        CONFIG,
        "matchmaking",
        key="delay_after_decline",
        default=DelayType.NONE,
        force_empty_values=True,
    )
    ...
    set_config_default(
        CONFIG, "matchmaking", key="opponent_allow_tos_violation", default=True
    )
    ...
    with open(config_file) as stream:
        ...
        if CONFIG["engine"]["protocol"] == "xboard":
            for section, subsection in (
                ...
                online_section = (CONFIG["engine"].get(section) or {}).get(
                    subsection
                ) or {}
                config_assert(
