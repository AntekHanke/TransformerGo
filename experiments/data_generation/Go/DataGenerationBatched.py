...
base_config = {
    ...
    #"GoSimpleGamesDataGeneratorTokenizedAlwaysBlack.sgf_files": "/plgantekhanke/raw_data/sgfs/val.txt",
    "GoSimpleGamesDataGeneratorTokenizedAlwaysBlack.save_data_every_n_games": 16000,
    "GoSimpleGamesDataGeneratorTokenizedAlwaysBlack.p_sample": 1.0,
    "GoSimpleGamesDataGeneratorTokenizedAlwaysBlack.max_games": 15000,
    "GoSimpleGamesDataGeneratorTokenizedAlwaysBlack.train_eval_split": 1.0,
    "GoSimpleGamesDataGeneratorTokenizedAlwaysBlack.save_path_to_eval_set": "/plgantekhanke/tokenized_data/train/",
    "GoSimpleGamesDataGeneratorTokenizedAlwaysBlack.save_path_to_train_set": "/plgantekhanke/tokenized_data/train/",
...
experiments_list = create_experiments_helper(
    ...
    python_path="",
    tags=["dataset", "generate", "tokenized", "go", "train", "JGDB", "batched"],
    with_neptune=True,
    env={},
)
