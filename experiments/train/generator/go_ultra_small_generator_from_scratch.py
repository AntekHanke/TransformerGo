...
HISTORY = ""
OUT_DIR = "/plgantekhanke/models/ultra_small_generator_from_scratch"
...
experiment_config["TrainModelFromScratch.path_to_training_data"] = "/plgantekhanke/tokenized_data/test/"
...
experiments_list = create_experiments_helper(
    ...
    python_path="",
    tags=["train", "small", "policy", "from_scratch", "go", "cluster", "transformer", "testing"],
    with_neptune=True,
    env={},
)
