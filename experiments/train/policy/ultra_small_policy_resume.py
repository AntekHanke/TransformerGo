...
TRAIN_TYPE = "resume"
HISTORY = ""
OUT_DIR = "/out_models/ultra_small_policy_resume"

experiment_config = dict(
    **common_train_params[TRAIN_TYPE], **data_loading_header[TRAIN_TYPE + HISTORY], **ultra_small_data[TRAIN_TYPE]
)
experiment_config["ResumeTraining.out_dir"] = OUT_DIR

experiment_config["ResumeTraining.checkpoint_path"] = "/out_models/ultra_small_policy_from_scratch/"
...
experiments_list = create_experiments_helper(
    experiment_name=f"ultra_small_policy_resume",
    ...
    python_path="",
    tags=["train", "small", "policy", "resume"],
    with_neptune=True,
    env={},
)
