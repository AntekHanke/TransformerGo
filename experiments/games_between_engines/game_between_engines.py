...
white_engine_params["max_mcts_passes"] = 30

black_engine_params = stockfish_engine_params.copy()
black_engine_params["stockfish_path"] = STOCKFISH_PATH
black_engine_params["stockfish_depth"] = 8
...
experiments_list = create_experiments_helper(
    experiment_name=f"game-white-subgoal-mcts-30-black-stockfish-depth-8",
    ...
    python_path="",
    tags=["mcts", "random start", "game", "self-play", "stockfish"],
    with_neptune=True,
    env={},
)
